...
public class Player : MonoBehaviour
{
	...
	IEnumerator Respawn()
	{
        ...
        GameObject newPlayer = Instantiate(prefab, new Vector3(2.0f, 0, 0), Quaternion.identity);
	...
	public void RemovePoints(int index){
		if(entity.points > 0){
			...
			if(index == 2 && entity.resistence > 0){
				entity.resistence--;
			}
			if(index == 3 && entity.intelligence > 0){
				entity.intelligence--;
			}
			if(index == 4 && entity.willpower > 0){
				entity.willpower--;
			}
